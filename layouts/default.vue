<template>
        <header class = "flex flex-row w-full bg-pink-900 border-b-2 border-pink-400 max-sm:justify-between relative">
            ...
            'max-sm:hidden': !burger}">
                        <NuxtLink to = "/" class = "my-auto p-2 hover:bg-pink-700 hover:text-white max-sm:w-full max-sm:border-b-2 max-sm:border-black max-sm:text-center">Home</NuxtLink>
                        <div class = "my-auto p-2 hover:bg-pink-700 hover:text-white max-sm:w-full max-sm:text-center max-sm:px-0 max-sm:pb-0" @click="switch_submenu">Labs
                            <div class = "flex flex-col absolute top-full bg-white text-black w-56 text-center max-sm:relative max-sm:w-full max-sm:bg-red-100" v-show="submenu">
                                <NuxtLink to = "/Login" class = "my-auto p-2 border-b-2 border-black hover:bg-pink-700 hover:text-white max-sm:w-full max-sm:border-t-2 max-sm:text-center">Lab3</NuxtLink>
                                <NuxtLink to="/Login" class = "my-auto p-2 border-b-2 border-black hover:bg-pink-700 hover:text-white max-sm:w-full max-sm:text-center">Lab4</NuxtLink>
                                <NuxtLink to="/Login" class = "my-auto p-2 border-b-2 border-black hover:bg-pink-700 hover:text-white max-sm:w-full max-sm:text-center">Lab5</NuxtLink>
                                <NuxtLink to="/Login" class = "my-auto p-2 border-b-2 border-black hover:bg-pink-700 hover:text-white max-sm:w-full max-sm:border-black max-sm:text-center">Lab6</NuxtLink>
                            </div>
                        </div>
        ...
        <main class = "p-5 flex bg-pink-100 h-screen">
            <slot />
        </main>

        <footer class ="flex flex-row w-full bg-pink-400 border-t-2 border-pink-950 items-center justify-center px-4 py-2 gap-4">
            <a href="https://www.youtube.com/"><img src="assets/images/youtube.png" class = "w-16 h-16"></a>
            <a href="https://github.com/"><img src="assets\images\github-sign.png" class = "w-16 h-16"></a>
            <a href="https://www.instagram.com/"><img src="assets/images/instagram.png" class = "w-16 h-16 bg-transparent"></a>
        </footer>
</template>
...
useHead({
  script: [
    {
        async: true,
        src: 'https://www.googletagmanager.com/gtag/js?id=G-KEBP2J3WV2',
    },
    {
        innerHTML:` 
